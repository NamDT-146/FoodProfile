...
pub struct LoadedFoodProfile<'info, 'entrypoint> {
    ...
    pub owner: Pubkey,
    pub origin_array: Mutable<[u8; 32]>,
...
pub fn create_food_profile_handler<'info>(
    ...
    assign!(food_profile.borrow_mut().origin_array, Mutable::<[u8; 32]>::new(origin_array));
